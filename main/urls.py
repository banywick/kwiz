...
from .views import CreateEventView, CreatePostView, EventDetailView, MainView, PostDetailView, PostsListView, create_feedback, delete_event, delete_feedback, edit_event, \
      login_view, register_view, user_profile
